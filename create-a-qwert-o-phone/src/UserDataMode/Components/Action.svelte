<script lang="ts">
	...
	import { type QOPValidEventCodesString, QOPValidEventCodes, type ActionEventCodes } from '../initQOPUD';
    ...
    function handleAddActionCode() {
        function handleKeydownEvent(event: KeyboardEvent) {
            if (QOPValidEventCodes.includes(event.code as QOPValidEventCodesString)) {
                QOPUserData.addActionCode(event.code as QOPValidEventCodesString, propString, listString, listIndex, setString, setIndex);
    ...
    function handleRemoveActionCode(eventCode: string) {
        QOPUserData.removeActionCode(eventCode as QOPValidEventCodesString, propString, listString, listIndex, setString, setIndex);
    }
</script>
